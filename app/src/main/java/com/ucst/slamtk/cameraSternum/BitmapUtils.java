package com.ucst.slamtk.cameraSternum;
...
public class BitmapUtils {
    ...
    public static Bitmap saveBitMap(Context context, final byte[] data, int rectLeft, int rectTop, int rectWidth, int rectHeight, boolean isNeedCut) throws IOException {
    ...
    private static int getExifRotateDegree(String path,int rotation){
